...
const initialZones: Zone[] = [
  { id: 1, name: 'Downtown Market', coords: { x: 123.45, y: -456.78, z: 29.5 }, type: 'sell', items: [{ name: 'Cocaine', price: 500 }, { name: 'Weed', price: 150 }] },
  { id: 2, name: 'Harbor Deal Zone', coords: { x: -892.12, y: 234.56, z: 31.2 }, type: 'buy', items: [{ name: 'Meth', price: 800 }] },
  { id: 3, name: 'Alley Exchange', coords: { x: 456.78, y: 123.45, z: 28.9 }, type: 'sell', items: [{ name: 'Pills', price: 200 }] },
]
        ...
        if (editingZone) {
          setEditingZone({
            ...
            coords: {
              ...
              z: Math.round(Math.random() * 50 + 20)
            }
          })
        }
      })
